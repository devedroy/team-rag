...
TeamRag ingests the team's real knowledge: Teams/Webex threads, architecture docs, pull requests, tickets, meeting notes, and decisions. It indexes that knowledge so any question — human or machine — gets an answer grounded in what the team actually said, decided, and built.

---

## Why it exists

Knowledge in software teams is ephemeral. It lives in a Teams/Webex thread from 2022, in a PR description nobody reads, in a retro note nobody filed. When the person who made the call leaves, the reasoning leaves with them.
...
**Humans** — Engineers, PMs, and new hires ask questions in a chat interface and get answers with citations linking back to the original source (Teams/Webex thread, Confluence page, PR, Jira ticket).
...
- The team stops repeating the same questions in Teams/Webex.
